      ...
      <div className="relative z-10">
        <div className="text-center max-w-3xl mx-auto px-4 pt-16 sm:pt-20 pb-8 sm:pb-16">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-neutral-600 dark:text-neutral-300 px-2">
            Join the waitlist to be among the first to experience the future of trading psychology.
          </p>
        </div>
...
const items = [
  {
    title: "AI Trading Psychology Analysis",
    description: (
      <span className="text-sm">
        Transform your trading journal into actionable insights. Let AI help you understand your trading psychology and emotional patterns.
      </span>
    ),
    header: <SkeletonOne />,
  ...
  {
    title: "Journal That Works For You",
    description: (
      <span className="text-sm">
        Your personal trading companion that captures not just trades, but the psychology behind every decision. Simple, powerful, different.
      </span>
    ),
    header: <SkeletonTwo />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Get personalized reports that help you understand your trading behavior and emotional patterns. Identify what works and what doesn't.
      </span>
    ),
    header: <SkeletonFour />,
    className: "md:col-span-1",
    icon: <IconClockHour4 className="h-4 w-4 text-neutral-500" />,
  },
  {
    title: "Join the Community",
    description: (
      <span className="text-sm">
        Compete, learn, and grow with fellow traders. Rise through the ranks and unlock exclusive rewards.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
